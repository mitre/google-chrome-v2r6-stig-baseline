control "SV-221586" do
  ...
  desc "Disabling this function will prevent users from deleting their browsing history, which 
could be used to identify malicious websites and files that could later be used for anti-virus 
and Intrusion Detection System (IDS) signatures. Furthermore, preventing users from 
deleting browsing history could be used to identify abusive web surfing on government 
systems."
  desc "check", "Universal method: 
 1. In the omnibox (address bar) type chrome://policy 
 2. If the policy 
\"AllowDeletingBrowserHistory\" is not shown or is not set to false, this is a 
finding.
...
HKLM\\Software\\Policies\\Google\\Chrome\\
 3. If the \"AllowDeletingBrowserHistory\" value 
