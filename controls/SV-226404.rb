control "SV-226404" do
  ...
  desc "This policy forces the autofill form data to be imported from the previous default browser if 
enabled. If enabled, this policy also affects the import dialog.
If disabled, the autofill 
form data is not imported.
...
2. If 
ImportAutofillFormData is not displayed under the Policy Name column or it is not set to 0 
...
3. If the ImportAutofillFormData 
